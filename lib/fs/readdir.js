...
readdir = function (path, options) {
	var readdir, globalRules, ignoresData;
	...
	if (options.ignoreRules) {
		ignoresData = getIsIgnored(isArray(options.ignoreRules) ?
				options.ignoreRules : [options.ignoreRules], globalRules,
			options.watch);
		globalRules = ignoresData.globalRules;
		readdir.isIgnored = ignoresData.isIgnored;
	}
