...
module.exports = isIgnored = function (mode, path) {
	var options, cb, watch, globalRules, isIgnored, getMapFns, dirname, promise;
...
isIgnored.prepareRules = prepareRules;
isIgnored.applyGlobalRules = applyGlobalRules;
isIgnored.parseSrc = parseSrc;
